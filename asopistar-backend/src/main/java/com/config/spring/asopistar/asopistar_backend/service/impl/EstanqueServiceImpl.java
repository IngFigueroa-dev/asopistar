...
public class EstanqueServiceImpl implements EstanqueService {
    ...
    public EstanqueResponseDTO crear(EstanqueRequestDTO dto) {
        if (estanqueRepository.findByCodigo(dto.getCodigo()).isPresent())
            throw new BusinessException(
                "Ya existe un estanque con el código: " + dto.getCodigo());
        ...
        Estanque e = Estanque.builder()
            .codigo(dto.getCodigo()).nombre(dto.getNombre())
            .capacidad(dto.getCapacidad()).ubicacion(dto.getUbicacion())
            .estadoEstanque(dto.getEstadoEstanque()).productor(productor)
            .build();
    ...
    public EstanqueResponseDTO actualizar(Integer id, EstanqueRequestDTO dto) {
        Estanque e = estanqueRepository.findById(id)
            .orElseThrow(() -> new ResourceNotFoundException(
                "Estanque no encontrado con id: " + id));
        e.setNombre(dto.getNombre()); e.setCapacidad(dto.getCapacidad());
    ...
    private EstanqueResponseDTO toResponseDTO(Estanque e) {
        return EstanqueResponseDTO.builder()
            ...
            .nombre(e.getNombre()).capacidad(e.getCapacidad())
            .ubicacion(e.getUbicacion()).estadoEstanque(e.getEstadoEstanque())
